...
var navbar_content = {
		...
		refresh_url : 'image/navbar_ajax',
		toggle_url: 'image/navbar_toggle',
		tagaction_url: 'image/tag_action',
		nav_sections: {},
		...
		init_module: function(init_params) {
			...
			sect_elem = $('<div id="activetags_title">tags actifs</div>').addClass("nav_title").click(this.toggle_nav_section);
			gen_elem.append(sect_elem);
			gen_elem.append($('<div id="activetags_content" style="display: none;"></div>').addClass("nav_content"));

			sect_elem = $('<div id="tagslist_title">liste tag</div>').addClass("nav_title").click(this.toggle_nav_section);
			gen_elem.append(sect_elem);
			gen_elem.append($('<div id="tagslist_content" style="display: none;"></div>').addClass("nav_content"));
